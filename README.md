...
|---------------|-----------|-------------|------------|
| **RF01** | **Cadastro de Empresa** – O sistema deve permitir o cadastro de empresas, exigindo nome da empresa, CNPJ, e-mail, telefone, endereço e senha de acesso. | – | M |
...
| **RF12** | **Avaliação e Feedback** – O sistema deve solicitar que, ao final de um serviço, o usuário avalie a outra parte envolvida. A avaliação deve incluir uma nota geral, de 1 a 5, levando em conta a qualidade do serviço, comunicação e grau de confiabilidade. | RF01, RF02, RF04, RF07, RF09 | M |
...
| **RNF05** | O sistema deve garantir acessibilidade total, permitindo navegação completa via teclado, compatibilidade com leitores de tela e uso de marcação semântica adequada. | RF01–RF15 | S |
...
***Entrevista transcrita:*** [Transcrição]()
